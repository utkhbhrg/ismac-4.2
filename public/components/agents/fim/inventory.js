...
class Inventory extends react_1.Component {
    ...
    async getItemNumber(type) {
        ...
        const response = await wz_request_1.WzRequest.apiReq('GET', `/syscheck/${agentID}`, { params: this.buildFilter(type) });
        if (type === 'file') {
            return {
    ...
    noConfiguredMonitoring() {
        return (react_1.default.createElement(eui_1.EuiEmptyPrompt, { iconType: "filebeatApp", title: react_1.default.createElement("h2", null, "Integrity monitoring is not configured for this agent"), body: react_1.default.createElement(react_1.Fragment, null,
