    ...
    constructor() {
        ...
        this.suggestions = {
            files: [
                ...
                { type: 'q', label: 'mtime', description: "Date the file was modified", operators: ['=', '!=', '>', '<'], values: async (value) => lib_1.getFilterValues('mtime', value, this.props.agent.id, {}, this.formatDate) },
                { type: 'q', label: 'date', description: "Date of registration of the event", operators: ['=', '!=', '>', '<'], values: async (value) => lib_1.getFilterValues('date', value, this.props.agent.id, {}, this.formatDate) },
                ...
                { type: 'q', label: 'size', description: "Size of the file in Bytes", values: async (value) => lib_1.getFilterValues('size', value, this.props.agent.id) },
            ],
            registry: [
    ...
    render() {
        ...
        return (react_1.default.createElement(eui_1.EuiFlexGroup, null,
            react_1.default.createElement(eui_1.EuiFlexItem, null,
                react_1.default.createElement(wz_search_bar_1.WzSearchBar, { noDeleteFiltersOnUpdateSuggests: true, filters: filters, onFiltersChange: onFiltersChange, suggestions: this.suggestions[selectView], placeholder: 'Filter or search file' }))));
    }
}
