...
class Inventory extends react_1.Component {
    constructor(props) {
        super(props);
        this._isMount = false;
        this.getItems = () => !!this.checks && this.checks.filter(check => this.state.filters.every(filter => filter.field === 'search'
        ...
        this.toggleDetails = item => {
            ...
            if (itemIdToExpandedRowMap[item.id]) {
                ...
                const listItems = [
                    ...
                    {
                        title: checks,
                        description: react_1.default.createElement(components_1.RuleText, { rulesText: item.rulesText }),
                    },
                    {
                        title: 'Compliance',
                        description: react_1.default.createElement(components_1.ComplianceText, { complianceText: item.complianceText })
                    }
                ];
    ...
    addHealthResultRender(result) {
        ...
        return (react_1.default.createElement(eui_1.EuiHealth, { color: color(result), style: { textTransform: 'capitalize' } }, result || 'Not applicable'));
    }
    ...
    async loadScaPolicy(policy) {
        ...
        if (policy) {
            try {
                const checks = await this.wzReq.apiReq('GET', `/sca/${this.props.agent.id}/checks/${policy.policy_id}`, { params: { ...filtersObject } });
    ...
    async downloadCsv() {
        try {
            ...
            await wz_csv_1.default('/sca/' + this.props.agent.id + '/checks/' + this.state.lookingPolicy.policy_id, [], this.state.lookingPolicy.policy_id);
        }
        catch (error) {
    ...
    buttonStat(text, field, value) {
        return react_1.default.createElement("button", { onClick: () => this.setState({ filters: [{ field, value }] }) }, text);
    }
    render() {
                ...
                ((this.props.agent && (this.props.agent || {}).os && this.state.lookingPolicy && !this.state.loading) &&
                    react_1.default.createElement("div", null,
                        react_1.default.createElement(eui_1.EuiPanel, { paddingSize: "l" },
                            ...
                            react_1.default.createElement(eui_1.EuiFlexGroup, null,
                                react_1.default.createElement(eui_1.EuiFlexItem, null,
                                    react_1.default.createElement(eui_1.EuiStat, { title: this.buttonStat(this.state.lookingPolicy.pass, 'result', 'passed'), description: "Pass", titleColor: "secondary", titleSize: "m", textAlign: "center" })),
                                react_1.default.createElement(eui_1.EuiFlexItem, null,
                                    react_1.default.createElement(eui_1.EuiStat, { title: this.buttonStat(this.state.lookingPolicy.fail, 'result', 'failed'), description: "Fail", titleColor: "danger", titleSize: "m", textAlign: "center" })),
                                react_1.default.createElement(eui_1.EuiFlexItem, null,
                                    react_1.default.createElement(eui_1.EuiStat, { title: this.buttonStat(this.state.lookingPolicy.invalid, 'result', ''), description: "Not applicable", titleColor: "subdued", titleSize: "m", textAlign: "center" })),
                                react_1.default.createElement(eui_1.EuiFlexItem, null,
                            ...
                            react_1.default.createElement(eui_1.EuiFlexGroup, null,
                                react_1.default.createElement(eui_1.EuiFlexItem, null,
                                    react_1.default.createElement(wz_search_bar_1.WzSearchBar, { filters: this.state.filters, suggestions: this.suggestions[this.state.lookingPolicy.policy_id], placeholder: 'Filter or search', onFiltersChange: filters => { this.setState({ filters }); } }))),
                            react_1.default.createElement(eui_1.EuiFlexGroup, null,
                                react_1.default.createElement(eui_1.EuiFlexItem, null,
                                    react_1.default.createElement(eui_1.EuiInMemoryTable, { items: this.state.items, columns: this.columnsChecks, rowProps: getChecksRowProps, itemId: "id", itemIdToExpandedRowMap: this.state.itemIdToExpandedRowMap, isExpandable: true, sorting: sorting, pagination: pagination, loading: this.state.loadingPolicy })))))))));
    }
}
