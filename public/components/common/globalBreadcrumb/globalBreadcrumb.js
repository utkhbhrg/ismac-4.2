...
class WzGlobalBreadcrumb extends react_1.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", null, !!this.props.state.breadcrumb.length && (react_dom_1.default.createPortal(react_1.default.createElement(eui_1.EuiBreadcrumbs, { className: 'wz-global-breadcrumb', responsive: false, truncate: false, max: 6, breadcrumbs: this.props.state.breadcrumb.map(breadcrumb => breadcrumb.agent ? {
                text: (react_1.default.createElement("a", { style: { margin: '0px 0px -5px 0px', height: 20 }, className: "euiLink euiLink--subdued euiBreadcrumb ", onClick: (ev) => { ev.stopPropagation(); app_navigate_1.AppNavigate.navigateToModule(ev, 'agents', { "tab": "welcome", "agent": breadcrumb.agent.id }); this.router.reload(); }, id: "breadcrumbNoTitle" },
