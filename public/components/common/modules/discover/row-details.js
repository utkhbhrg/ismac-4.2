...
class RowDetails extends react_1.Component {
    ...
    async componentDidMount() {
        ...
        const rulesDataResponse = await wz_request_1.WzRequest.apiReq('GET', `/rules`, { params });
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement(eui_1.EuiFlexGroup, null,
                react_1.default.createElement(eui_2.EuiFlexItem, { style: { padding: 16 } },
                    ...
                    this.state.selectedTabId === 'rule' && this.state.ruleData.total_affected_items === 1 && (this.getRule()) || this.state.selectedTabId === 'rule' &&
