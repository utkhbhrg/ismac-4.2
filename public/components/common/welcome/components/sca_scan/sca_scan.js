...
class ScaScan extends react_1.Component {
    ...
    async getLastScan(agentId) {
        const scans = await wz_request_1.WzRequest.apiReq('GET', `/sca/${agentId}?sort=-end_scan`, { params: { limit: 1 } });
        this._isMount &&
            this.setState({
                ...
                react_1.default.createElement(eui_1.EuiFlexItem, { grow: false },
                    react_1.default.createElement(eui_1.EuiTitle, { size: "xs" },
                        react_1.default.createElement(eui_1.EuiLink, { onClick: () => {
                            ...
                            react_1.default.createElement("h4", null, lastScan.name)))),
                react_1.default.createElement(eui_1.EuiFlexItem, { grow: false, style: { marginTop: 12 } },
