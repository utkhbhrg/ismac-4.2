    ...
    */
    ...
    renderFacet() {
        ...
        if (tacticsToRender.length) {
            return (react_1.default.createElement(eui_1.EuiFlexGrid, { columns: 4, gutterSize: "s", style: { maxHeight: "calc(100vh - 385px)", overflow: "overlay", overflowX: "hidden", maxWidth: "82vw", paddingRight: 10 } }, tacticsToRenderOrdered));
        }
        else {
