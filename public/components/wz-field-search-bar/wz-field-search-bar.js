...
exports.WzFieldSearch = ({ searchDelay, onSearch, onChange, ...rest }) => {
    ...
    return react_1.default.createElement(eui_1.EuiFieldSearch, Object.assign({ value: searchTerm, onChange: onChangeSearchTerm, onSearch: () => onSearch(searchTerm) }, rest));
};
