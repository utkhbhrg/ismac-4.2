 ...
 * under the License.
 */
const saved_object_loader_1 = require("./saved_object_loader");
const find_list_items_1 = require("../../../../src/plugins/visualizations/public/saved_visualizations/find_list_items");
const _saved_vis_1 = require("../../../../src/plugins/visualizations/public/saved_visualizations/_saved_vis");
function createSavedVisLoader(services) {
    const { savedObjectsClient, visualizationTypes } = services;
    class SavedObjectLoaderVisualize extends saved_object_loader_1.SavedObjectLoader {
        constructor() {
            super(...arguments);
